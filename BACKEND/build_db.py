...
if INDEX_NAME in existing_indexes:
    ...
    TARGET_DIMENSION = index_info.dimension
    print(f"Using existing index with dimension {TARGET_DIMENSION}. Embeddings will be padded.")
...
def embed_text(text: str):
    ...
    if len(embedding) < TARGET_DIMENSION:
        embedding.extend([0.0] * (TARGET_DIMENSION - len(embedding)))
    return embedding
